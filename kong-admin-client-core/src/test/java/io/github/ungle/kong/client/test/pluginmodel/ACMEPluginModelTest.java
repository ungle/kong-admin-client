...
import io.github.ungle.kong.client.model.plugins.security.ACMEConfig;
...
public class ACMEPluginModelTest {
	...
	public void createPlugin() throws Exception {
		...
		String pluginName = InnerPluginName.ACME.getPluginName();
		request.setName(pluginName);
		request.setConfig(ACMEConfig.builder().withAccountEmail("tkyxj@kong.com").build());
		...
		assertFalse(tree.get("allow_any_domain").asBoolean());
