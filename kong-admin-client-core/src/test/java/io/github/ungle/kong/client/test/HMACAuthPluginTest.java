...
import io.github.ungle.kong.client.api.plugins.HMACAuthCredentialsApi;
...
public class HMACAuthPluginTest {
	
	HMACAuthCredentialsApi credentialsApi;
    ...
    public void initTest() {
        ...
        credentialsApi = kongClientFactory.getApiInstance(HMACAuthCredentialsApi.class);
    ...
    public void testAddCredential() throws Exception {
        HMACAuthCredentialsRequest credentialsRequest =new HMACAuthCredentialsRequest();
        credentialsRequest.setUsername(name);
        HMACAuthCredentialsResponse credentialsResponse = credentialsApi.add(consumerId, credentialsRequest);
    ...
    public void testFind() {
    	HMACAuthCredentialsResponse result = credentialsApi.find().getData().get(0);
    ...
    public void testFindByConsumer() throws Exception {
        ApiDataList<HMACAuthCredentialsResponse> credentialsResponse  = credentialsApi.findByConsumer(name);
