...
import org.kastin.kong.client.api.CertificateApi;
import org.kastin.kong.client.feignclient.KongClientFactory;
import org.kastin.kong.client.requests.CertificateRequest;
import org.kastin.kong.client.response.CertificateResponse;
...
public class CertificateTest {
    ...
    public void initTest() {
        ...
        api = kongClientFactory.getApiInstance(CertificateApi.class);
	...
	public void addTest() {
		...
		request.setKey(key);
		CertificateResponse result = api.add(request);
		assertTrue(result.getKey().contains("R8IGIl2uRUbEafDv"));
	...
	public void findTest() {
		List<CertificateResponse> resultList = api.find().getData();
		assertEquals(certificateId, resultList.get(0).getId());
	}
	...
	public void updateTest() {
		...
		CertificateResponse result = api.update(certificateId, request);
