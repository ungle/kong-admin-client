package org.kastin.kong.starter.configuration;

import feign.Retryer;
import okhttp3.ConnectionPool;
import okhttp3.OkHttpClient;

import org.kastin.kong.client.api.*;
import org.kastin.kong.client.api.plugins.AclApi;
import org.kastin.kong.client.api.plugins.Oauth2Api;
import org.kastin.kong.client.feignclient.KongClientFactory;
import org.kastin.kong.client.feignclient.KongLegencyDecoder;
...
public class KongAutoConfiguration {
    ...
    public OkHttpClient okHttpClient() {
        return new OkHttpClient
                .Builder()
                .connectTimeout(kongProperties.getOkhttp().getConnectTimeout())
                ...
                .connectionPool(new ConnectionPool(kongProperties.getOkhttp().getPool().getMaxIdleConnections(), kongProperties.getOkhttp().getPool().getKeepAliveDuration(), kongProperties.getOkhttp().getPool().getTimeUnit()))
                .build();
    }
    ...
    public KongClientFactory kongClientFactory(@Qualifier("kongOkHttp") OkHttpClient okHttpClient) {
        ...
        KongClientFactory.Builder builder = KongClientFactory.builder().client(okHttpClient)
                ...
                .logLevel(kongProperties.getLogLevel())
                .targets(kongProperties.getTargets());
        if (kongProperties.getAuth() != null) {
            ...
            if (authProperties.getBasicAuth() != null) {
                builder.basicAuth(authProperties.getBasicAuth().getUsername(), authProperties.getBasicAuth().getPassword());
